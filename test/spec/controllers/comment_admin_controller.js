...
describe('Controller: CommentAdminCtrl as AdminCommentAdminCtrl', function() {
  ...
  beforeEach(module('portfolioApp.blogAdminController', 'testConstants', 'portfolioApp.blogAdminService', 'portfolioApp.blogCommentsService', 'underscore'));
    ...
    returnedBlogComments = [
      {
        ...
        'url': 'http://portfolio-12501.onmodulus.net/#!/',
        'message': 'This is a message here',
        'blogId': '139938',
        'published': true,
        'publishedDate': '2014-05-19T17:54:14.384Z',
        '_id': '537a4546fd2831630749de1b',
        '__v': 0
      },
      {
        'name': 'John Williams',
        'email': 'andy_walpole@btopenworld.com',
        'url': 'http://andywalpole.me/#!/blog/137153/books-helped-become-professional-web-developer',
        'message': 'This is another comment message here',
        'blogId': '139938',
        'published': true,
        'publishedDate': '2014-05-19T17:55:09.537Z',
        '_id': '537a457dfd2831630749de1c',
        '__v': 0
      }
    ];

    publishedBlogComment = {
      'name': 'John Huskin',
      'email': 'andy_walpole@btopenworld.com',
      'url': 'http://andywalpole.me/#!/blog/137153/books-helped-become-professional-web-developer',
      'message': 'This is a blog comment',
      'blogId': '139938',
      'published': true,
      'publishedDate': '2014-05-19T18:57:23.034Z',
      '_id': '537a541344c9ef1f4e60e40e',
      '__v': 0
    };
