...
describe('Controller: BlogArticleCtrl as BlogArticlePageCtrl', function () {
  ...
  beforeEach(module('testConstants', 'portfolioApp.blogPagesController', 'portfolioApp.blogPagesService', 'portfolioApp.blogAdminService', 'portfolioApp.blogPagesService', 'AppConstants', 'ngSanitize', 'ngRoute', 'HashBangURLs', 'portfolioAppConfig', 'jmdobry.angular-cache', 'underscore'));
