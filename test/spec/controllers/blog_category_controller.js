...
describe('Controller: BlogCatController as BlogCatPageController', function () {
  ...
  beforeEach(module('testConstants', 'portfolioApp.blogPagesController', 'portfolioApp.blogPagesService', 'portfolioApp.blogAdminService', 'AppConstants', 'ngRoute', 'portfolioAppConfig', 'jmdobry.angular-cache'));
