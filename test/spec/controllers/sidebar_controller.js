...
describe('Controller: SidebarCtrl', function() {
  ...
  beforeEach(module('testConstants', 'portfolioApp.blogSidebarController', 'portfolioApp.blogAdminService', 'portfolioApp.blogPagesService', 'AppConstants', 'ngSanitize', 'ngRoute', 'HashBangURLs', 'portfolioAppConfig', 'jmdobry.angular-cache', 'underscore', 'detectLocalStorage', 'fastclick'));
