...
angular.module("portfolioApp.homepageDirective").directive("sliderDirective", [
  "SLIDER",
  "$interval",
  "$timeout",
  "$animate",
  ...
  function (
    ...
    return {
      ...
      replace: true,
      template:
        '<div id="slider" data-ng-class="slider.sliderClass" tabindex="0">' +
        "<section>" +
        ...
        var sliderDirectiveLink = {
          ...
          timer: function () {
            ...
            sliderDirectiveLink.timerInterval = $interval(function () {
              ...
              if (
                scope.slideController.currentSlide <
                sliderDirectiveLink.sliderTotal
              ) {
                scope.slideController.sliderForMethod(
          ...
          navigation: function () {
            angular
              .element(element[0].querySelector(".right-arrow"))
              .bind("click", function () {
            ...
            angular
              .element(element[0].querySelector(".left-arrow"))
              .bind("click", function () {
