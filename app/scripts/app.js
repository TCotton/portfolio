 ...
 */
angular.module('portfolioApp', ['AppConstants', 'ngCookies', 'ngResource', 'ngSanitize', 'ngRoute', 'ngTouch', 'ngAnimate', 'localization', 'fastBind.bindOnce', 'fastBind.bindAttrOnce', 'HashBangURLs', 'portfolioAppConfig', 'LocalStorageModule', 'portfolioAppFilters' ])
