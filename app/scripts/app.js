...
angular.module('portfolioApp', ['portfolioApp.controllers', 'portfolioApp.directives', 'portfolioApp.services', 'AppConstants', 'ngCookies', 'ngResource', 'ngSanitize', 'ngRoute', 'ngAnimate', 'HashBangURLs', 'portfolioAppConfig', 'jmdobry.angular-cache', 'ga'])
