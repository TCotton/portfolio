 ...
 */
angular.module('portfolioApp', ['AppConstants', 'ngCookies', 'ngResource', 'ngSanitize', 'ngRoute', 'ngTouch', 'ngAnimate', 'HashBangURLs', 'portfolioAppConfig', 'LocalStorageModule', 'portfolioAppFilters', 'mongolabResourceHttp', 'DBConstants' ])
