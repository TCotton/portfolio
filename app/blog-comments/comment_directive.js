...
angular.module('portfolioApp.blogCommentsDirective').directive('commentDirective', [function() {
  return {
    ...
    '<p>' +
    '<a data-ng-href="{{comment.url}}" rel="external" class="underline">' +
    '<span data-ng-bind="comment.name" itemprop="creator"></span></a>' +
    '<br>' +
    '<span data-ng-bind="comment.publishedDate | date" itemprop="commentTime"></span>' +
    '</p>' +
    '</header> ' +
    '<header data-ng-if="!comment.url">' +
    '<p>' +
    '<span data-ng-bind="comment.name" itemprop="creator"></span><br>' +
    '<span data-ng-bind="comment.publishedDate | date" itemprop="commentTime"></span>' +
    '</p>' +
    '</header>' +
